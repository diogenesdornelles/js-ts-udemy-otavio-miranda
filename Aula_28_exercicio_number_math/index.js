...
const numeroTitulo = document.getElementById('numero-escolhido'); // seleciona o elemento inteiro: "<span id="numero-escolhido">0</span>"

const textoInfo = document.getElementById('texto-info'); // <div id="texto-info">Texto</div>
...
textoInfo.innerHTML = `<p>Seu número mais 2 é: ${num + 2} </p>
                      ...
                      <p>Arredondado para cima: ${num.toFixed()} </p>`;
